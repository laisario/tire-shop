                  ...
                  {product.imgs.thumbnails?.map((img, key) => (
                    <button
                      ...
                      className={`flex items-center justify-center w-20 h-20 overflow-hidden rounded-lg bg-gray-1 ease-out duration-200 hover:border-2 hover:border-blue ${
                        activePreview === key && "border-2 border-gray-5"
                      }`}
                    >
                      <Image
                        src={img || ""}
            ...
            <div className="max-w-[445px] w-full">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex items-center justify-center w-10 h-10 rounded-[5px] bg-gray-2 text-dark ease-out duration-200 hover:text-gray-5"
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium text-white bg-gray-7 py-3 px-7 rounded-md ease-out duration-200 hover:bg-gray-5
                  `}
                >
