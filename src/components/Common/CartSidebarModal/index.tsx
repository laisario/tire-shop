        ...
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              ...
              <p className="font-medium text-xl text-dark">R${totalPrice}</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full flex justify-center font-medium text-white bg-yellow py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-blue-dark"
              >
                Ver carrinho
              </Link>
              ...
              <Link
                href="/checkout"
                className="w-full flex justify-center font-medium text-white bg-gray-7 py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-opacity-95"
              >
                Finalizar compra
              </Link>
            </div>
