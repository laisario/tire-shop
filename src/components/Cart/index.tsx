...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={"Lista de interesses"} pages={["Lista de interesses"]} />
      </section>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-dark text-2xl">Sua lista de interesses</h2>
              <button className="text-black hover:text-gray-5" onClick={clearList}>Limpar lista</button>
            </div>
            ...
            <div className="bg-white rounded-[10px] shadow-1">
              <div className="w-full">
                <div>
                  {/* <!-- table header --> */}
                  <div className="flex items-center justify-between py-5.5 px-7.5">
                    ...
                    <div className="min-w-[325px]" >
                      <p className="invisible lg:visible text-dark">Quantidade</p>
                    </div>
        ...
        <>
          <div className="text-center mt-16">
            ...
            <p className="pb-6">Sua lista de interesses está vazia.</p>
