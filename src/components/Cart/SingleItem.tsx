...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between gap-y-4 lg:items-center border-t border-gray-3 py-5 px-7.5">
      <div className="max-w-[400px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            ...
            <div>
              <h3 className="text-dark ease-out duration-200 hover:text-gray-5">
      ...
      {/* <div className="min-w-[200px]">
        ...
        tem.discountedPrice * quantity}</p>
      </div> */}

      <p className="lg:invisible text-dark">Quantidade:</p>
      <div className="flex">
