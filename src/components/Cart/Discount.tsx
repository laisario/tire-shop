      ...
      <form>
        ...
        <div className="bg-white shadow-1 rounded-[10px]">
          <div className="border-b border-gray-3 py-5 px-4 sm:px-5.5">
            <h3 className="">Tem algum cupom de desconto?</h3>
          </div>
          ...
          <div className="py-8 px-4 sm:px-8.5">
            <div className="flex flex-wrap gap-4 xl:gap-5.5">
              ...
              <button
                type="submit"
                className="inline-flex font-medium text-white bg-yellow py-3 px-8 rounded-md ease-out duration-200 hover:bg-blue-dark"
              >
                Aplicar desconto
              </button>
            </div>
