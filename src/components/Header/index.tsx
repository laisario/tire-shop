...
const Header = () => {
  ...
  const [selectedOption, setSelectedOption] = useState(isMobile ? null : "medida");
  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-[1170px] mx-auto  px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-row lg:flex-nowrap  justify-around gap-5 items-start lg:items-center xl:justify-between ease-out duration-200 ${
            stickyMenu ? "py-4" : "py-6"
          }`}
        >
          {/* <!-- header LOGO --> */}
          <div className="w-auto bg-yellow p-2 rounded  sm:flex-row flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link  href="/">
              <Image
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-yellow w-4.5 h-4.5 rounded-full text-dark">
                      {product.length}
                    </span>
                  </span>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-yellow text-custom-sm font-medium  flex ${
